...
package lte.statelearner.lteuesimulator;
...
public class LTEUESimSUL implements StateLearnerSUL<String, String> {
	LTEUESimConfig config;
	SimpleAlphabet<String> alphabet;
	Socket socket;
	BufferedWriter out;
	BufferedReader in;

	public LTEUESimSUL(LTEUESimConfig config) throws Exception {
		this.config = config;
	...
	public SUL<String, String> fork() throws UnsupportedOperationException {
		throw new UnsupportedOperationException("Cannot fork LTEUESimSUL");
	}
