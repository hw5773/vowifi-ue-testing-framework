...
public:
  ...
  bool send_initial_context_setup_request(nas* nas_ctx, uint16_t erab_to_setup);
    bool send_initial_context_setup_request_tau(nas* nas_ctx, uint16_t erab_to_setup);
  ...
  bool handle_statelearner_ue_context_release_request(nas* nas_ctx, struct sctp_sndrcvinfo*  enb_sri);
    bool handle_statelearner_ue_context_release_request_tau(nas* nas_ctx, struct sctp_sndrcvinfo*  enb_sri);
  //===========================================================================================

    bool send_ue_context_release_command(nas* nas_ctx);
    bool send_ue_context_release_command_tau(nas* nas_ctx);
