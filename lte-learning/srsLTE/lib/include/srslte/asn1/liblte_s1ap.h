...
typedef enum {
  ...
  LIBLTE_S1AP_PROC_ID_UECONTEXTRELEASE_TAU                     = 50,
...
/*******************************************************************************
/* Protocol Message UEContextReleaseCommandtau STRUCT
********************************************************************************/
typedef struct {
    bool                           ext;
    LIBLTE_S1AP_UE_S1AP_IDS_STRUCT UE_S1AP_IDs;
    LIBLTE_S1AP_CAUSE_STRUCT       Cause;
} LIBLTE_S1AP_MESSAGE_UECONTEXTRELEASECOMMAND_STRUCT_TAU;

LIBLTE_ERROR_ENUM liblte_s1ap_pack_uecontextreleasecommand_tau(LIBLTE_S1AP_MESSAGE_UECONTEXTRELEASECOMMAND_STRUCT_TAU* ie,
                                                           uint8_t**                                           ptr);
LIBLTE_ERROR_ENUM liblte_s1ap_unpack_uecontextreleasecommand_tau(uint8_t**                                           ptr,
                                                             LIBLTE_S1AP_MESSAGE_UECONTEXTRELEASECOMMAND_STRUCT* ie);
/*******************************************************************************
...
typedef enum {
  ...
  LIBLTE_S1AP_INITIATINGMESSAGE_CHOICE_UECONTEXTRELEASECOMMAND_TAU,
  LIBLTE_S1AP_INITIATINGMESSAGE_CHOICE_N_ITEMS
} LIBLTE_S1AP_INITIATINGMESSAGE_CHOICE_ENUM;
static const char liblte_s1ap_initiatingmessage_choice_text[LIBLTE_S1AP_INITIATINGMESSAGE_CHOICE_N_ITEMS][51] = {
...
typedef union {
  ...
  LIBLTE_S1AP_MESSAGE_UECONTEXTRELEASECOMMAND_STRUCT              UEContextReleaseCommand;
    LIBLTE_S1AP_MESSAGE_UECONTEXTRELEASECOMMAND_STRUCT_TAU              UEContextReleaseCommandtau;
...
LIBLTE_ERROR_ENUM liblte_s1ap_pack_s1ap_pdu_tau(LIBLTE_S1AP_S1AP_PDU_STRUCT* s1ap_pdu, LIBLTE_BYTE_MSG_STRUCT* msg);
