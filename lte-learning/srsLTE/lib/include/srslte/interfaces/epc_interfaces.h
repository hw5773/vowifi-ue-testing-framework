...
public:
  virtual bool send_create_session_request(uint64_t imsi)                                                         = 0;
    virtual bool send_create_session_request_tau(uint64_t imsi)                                                         = 0;
...
public:
  ...
  //Fuzzing
  virtual bool     notify_response(uint8_t *msg, uint16_t len)                               = 0; //Fuzzing
  virtual bool     get_mme_statelearner_reset_state()                                        = 0; //Fuzzing
};
